...
def main():
    ...
    csv_writer = csv.DictWriter(out_f, fieldnames=["time", "intensity", "url"], lineterminator="\n")
    ...
    for hmr in parsed.xpath('//property[@name="heatMarkerRenderer"]'):
        ...
        score = hmr.xpath('.//property[@name="heatMarkerIntensityScoreNormalized"]/number/@value')[0]
        print(start, score)
